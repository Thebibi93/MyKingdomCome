...
public class MagicCatapultTowerView extends TowerView {
    
    public MagicCatapultTowerView(int level, int cellSize) {
    ...
    private static BufferedImage towerSprite(int level, int cellSize) {
        ...
        try {
            switch (level) {
                case 1:
                    base = ImageIO
                            .read(ArcherTowerView.class.getResourceAsStream("/towers/base/magicCatapultTower.png"))
    ...
    private static AnimatedSprite weaponSprite(int level, int cellSize) {
        switch (level) {
            case 1:
                return MakeSprite.makeSpriteAnimation("/towers/weapon/magicCatapultTower/level1.png", 17, 96, 96, 8)
                        .resize(cellSize, cellSize);
            case 2:
                return MakeSprite.makeSpriteAnimation("/towers/weapon/magicCatapultTower/level2.png", 17, 96, 96, 8)
                        .resize(cellSize, cellSize);
            case 3:
                return MakeSprite.makeSpriteAnimation("/towers/weapon/magicCatapultTower/level3.png", 17, 96, 96, 8)
                        .resize(cellSize, cellSize);
            default:
                break;
        }
